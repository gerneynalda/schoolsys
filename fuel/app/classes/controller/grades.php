...
class Controller_Grades extends Controller_Template
{
	...
	{	
		...
		$custom_menu .= '<form class="navbar-form navbar-left" role="search">
			<button type="button" class="btn btn-primary btn-sm" id="input-switching-direction" title="Switching input direction" ><i class="glyphicon glyphicon-arrow-down"></i></button>
		</form>
		';
