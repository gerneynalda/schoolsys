...
class Controller_Reportcard extends Controller_Template
{
	...
	public function action_index()
	{
		...
		$custom_menu = '';
		$custom_menu .= '<form class="navbar-form navbar-left">';
		$custom_menu .= '<div class="form-group">';
		$custom_menu .= '<button type="button" class="btn btn-primary btn-sm" id="generate_report_card">Generate Report Card</button>';
		$custom_menu .= '</div>';
		$custom_menu .= '</form>';
		...
		$custom_menu .= '<select class="form-control" id="schoolyear">';
		...
		// classes
		$custom_menu .= '<div class="form-group form-group-sm">';
		$custom_menu .= '<select class="form-control" id="class">';
		...
		// curriculums
		$custom_menu .= '<div class="form-group form-group-sm">';
		$custom_menu .= '<select class="form-control" id="curriculum">';
		...
		// strands
		$custom_menu .= '<div class="form-group form-group-sm">';
		$custom_menu .= '<select class="form-control" id="strand">';
		...
		$custom_menu .= '<button type="button" class="btn btn-primary btn-sm" id="showStudents">Show Student(s)</button>';
		$custom_menu .= '</form>';
		
		// send menu to the template
		$this->template->set('customMenu', $custom_menu, false);

		$this->template->set_global('styles', ["grades.css", "generate_reportcard.css"]);
		$this->template->set_global('scripts', ["generatereportcard.js"]);
		$this->template->title = 'Report Card';	
		$this->template->content = View::forge('reportcard/index', null, false);
	}
